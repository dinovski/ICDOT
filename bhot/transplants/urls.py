...
urlpatterns = [
    ...
    path("detail/<str:pk>", view=transplant_detail_view, name="detail"),
    path("update/<str:pk>", view=transplant_update_view, name="update"),
    path("delete/<str:pk>", view=transplant_delete_view, name="delete"),
]
