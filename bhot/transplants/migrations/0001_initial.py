# Generated by Django 3.2.10 on 2022-03-14 14:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creatinemia', models.FloatField(blank=True, null=True)),
                ('creatinemia_units', models.CharField(choices=[('umol/L', 'umol/L'), ('mg/L', 'mg/L')], default='umol/L', max_length=50)),
                ('creatinuria', models.FloatField(blank=True, null=True)),
                ('creatinuria_units', models.CharField(choices=[('mmol/L', 'mmol/L')], default='mmol/L', max_length=50)),
                ('proteinuria', models.FloatField(blank=True, null=True)),
                ('proteinuria_units', models.CharField(choices=[('g/g', 'g/g'), ('g/24h', 'g/24h'), ('mg/dL', 'mg/dL'), ('g/L', 'g/L'), ('mg/mmol', 'mg/mmol'), ('g/mmol', 'g/mmol')], default='mg/dL', max_length=50)),
                ('proteinuria_dipstick', models.CharField(blank=True, choices=[('0', '0'), ('+', '+'), ('++', '++'), ('+++', '+++'), ('++++', '++++')], max_length=20)),
                ('proteinuria_dipstick_units', models.CharField(choices=[('mg/dL range', 'mg/dL range')], default='mg/dL range', max_length=50)),
                ('proteinuria_date', models.DateField(blank=True, null=True)),
                ...
                ('preformed_dsa', models.BooleanField(blank=True, null=True, verbose_name='pre-formed DSA')),
                ...
                ('ci_score', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3)])),
                ('ct_score', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3)])),
                ('cv_score', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3)])),
                ('ah_score', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor_ethnicity', models.CharField(blank=True, choices=[('American Indian or Alaska Native', 'American Indian or Alaska Native)'), ('Asian', 'Asian'), ('Black or African American', 'Black or African American'), ('Hispanic or Latino', 'Hispanic or Latino'), ('Pacific Islander', 'Pacific Islander'), ('white', 'white')], max_length=100)),
                ...
                ('donor_egfr_date', models.DateField(blank=True, null=True)),
                ...
                ('donor_proteinuria_units', models.CharField(choices=[('g/g', 'g/g'), ('g/24h', 'g/24h'), ('mg/dL', 'mg/dL'), ('g/L', 'g/L'), ('mg/mmol', 'mg/mmol'), ('g/mmol', 'g/mmol')], default='mg/dL', max_length=50)),
                ...
                ('donor_proteinuria_date', models.DateField(blank=True, null=True)),
                ...
                ('cold_ischemia_time_units', models.CharField(blank=True, choices=[('minutes', 'minutes'), ('hours', 'hours'), ('days', 'days')], max_length=50)),
                ...
                ('dgf_time_units', models.CharField(blank=True, choices=[('minutes', 'minutes'), ('hours', 'hours'), ('days', 'days')], max_length=50, verbose_name='delayed graft function time units')),
                ...
                ('recipient_weight_units', models.CharField(choices=[('centimeters', 'centimeters (cm)'), ('meters', 'meters (m)'), ('inches', 'inches (in)'), ('feet', 'feet (ft)')], default='centimeters', max_length=50)),
                ('recipient_sex', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other')], max_length=1)),
                ('recipient_ethnicity', models.CharField(blank=True, choices=[('American Indian or Alaska Native', 'American Indian or Alaska Native)'), ('Asian', 'Asian'), ('Black or African American', 'Black or African American'), ('Hispanic or Latino', 'Hispanic or Latino'), ('Pacific Islander', 'Pacific Islander'), ('white', 'white')], max_length=100)),
                ...
                ('previous_transplant', models.CharField(blank=True, choices=[('no', 'no'), ('heart', 'heart'), ('kidney', 'kidney'), ('liver', 'liver'), ('lung', 'lung')], max_length=100)),
                ...
                ('recipient_systolic_bp', models.IntegerField(blank=True, null=True, verbose_name='recipient systolic blood pressure (mm Hg)')),
                ('recipient_diastolic_bp', models.IntegerField(blank=True, null=True, verbose_name='recipient diastolic blood pressure (mm Hg)')),
                ...
                ('recipient_egfr', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(500.0)], verbose_name='recipient eGFR (mL/min/1.73m2)')),
                ('recipient_egfr_date', models.DateField(blank=True, null=True, verbose_name='recipient eGFR date')),
                ('recipient_proteinuria', models.FloatField(blank=True, null=True)),
                ('recipient_proteinuria_units', models.CharField(choices=[('g/g', 'g/g'), ('g/24h', 'g/24h'), ('mg/dL', 'mg/dL'), ('g/L', 'g/L'), ('mg/mmol', 'mg/mmol'), ('g/mmol', 'g/mmol')], default='mg/dL', max_length=50)),
                ('recipient_proteinuria_dipstick', models.CharField(blank=True, choices=[('0', '0'), ('+', '+'), ('++', '++'), ('+++', '+++'), ('++++', '++++')], max_length=20)),
                ('recipient_proteinuria_dipstick_units', models.CharField(choices=[('mg/dL range', 'mg/dL range')], default='mg/dL range', max_length=50)),
                ('recipient_proteinuria_date', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rna_storage', models.CharField(choices=[('FFPE', 'FFPE'), ('RNAlater', 'RNAlater'), ('frozen', 'frozen')], default='FFPE', max_length=100)),
