# Generated by Django 3.2.10 on 2022-03-02 09:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creatinemia_units', models.CharField(choices=[('umol/L', 'umol/L'), ('mg/L', 'mgdL')], default='umol/L', max_length=50)),
                ...
                ('prot_creat_ratio', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(30.0)], verbose_name='Protein/creatinine ratio (g/g)')),
                ('prot_creat_ratio_units', models.CharField(choices=[('g/g', 'g/g')], default='g/g', max_length=50)),
                ('immunosuppressants', models.CharField(blank=True, choices=[('Abatacept', 'Abatacept'), ('Azathioprine', 'Azathioprine'), ('Belatacept', 'Belatacept'), ('Cyclosporine', 'Cyclosporine'), ('Everolimus', 'Everolimus'), ('MMF', 'MMF'), ('MPA', 'MPA'), ('Prednisone', 'Sirolimus'), ('Sirolimus', 'Azathioprine'), ('Tacrolimus', 'Tacrolimus')], max_length=100, verbose_name='Immunosuppresants')),
                ('immunosuppressant_dose', models.FloatField(blank=True, null=True)),
                ('immunosuppressant_dose_units', models.CharField(choices=[('mg/day', 'mg/day'), ('mg twice per day', 'mg twice per day'), ('mg per week', 'mg per week'), ('mg per 15 days', 'mg per 15 days')], max_length=100, null=True, verbose_name='Immunosuppresant dose units')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor_ethnicity', models.CharField(blank=True, choices=[('American Indian or Alaska Native', 'American Indian or Alaska Native)'), ('Asian', 'Asian'), ('Black or African American', 'Black or African American'), ('Hispanic or Latino', 'Hispanic or Latino'), ('Pacific Islander', 'feet (ft)'), ('white', 'white')], max_length=100)),
                ...
                ('donor_creatinemia_units', models.CharField(choices=[('umol/L', 'umol/L'), ('mg/L', 'mgdL')], default='umol/L', max_length=50)),
                ...
                ('hla_a_mismatches', models.IntegerField(blank=True, null=True, verbose_name='total HL-A mismatches')),
                ('hla_b_mismatches', models.IntegerField(blank=True, null=True, verbose_name='total HL-A mismatches')),
                ('hla_dr_mismatches', models.IntegerField(blank=True, null=True, verbose_name='total HL-A mismatches')),
                ('cold_ischemia_time', models.FloatField(blank=True, null=True)),
                ...
                ('dgf_time', models.BooleanField(blank=True, choices=[('minutes', 'minutes'), ('hours', 'hours'), ('days', 'days')], null=True, verbose_name='delayed graft function time')),
                ...
                ('recipient_ethnicity', models.CharField(blank=True, choices=[('American Indian or Alaska Native', 'American Indian or Alaska Native)'), ('Asian', 'Asian'), ('Black or African American', 'Black or African American'), ('Hispanic or Latino', 'Hispanic or Latino'), ('Pacific Islander', 'feet (ft)'), ('white', 'white')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_protocol', models.CharField(choices=[('high sensitivity', 'high sensitivity'), ('standard', 'standard')], max_length=50)),
