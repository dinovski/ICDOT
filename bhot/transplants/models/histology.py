...
class Histology(UserScopedModel):
    ...
    class TMAlocation(models.TextChoices):
        ADEQUATE = "arteriolar", _("arteriolar")
    ...
    class EndothelialActivation(models.TextChoices):
        MESANGIAL = "hypertrophy", _("hypertrophy")
        SUBEPITHELIAL = "loss of fenestrations", _("loss of fenestrations")
        SUBENDOTHELIAL = "subendothelial lucency", _("subendothelial lucency")
        # other:specify
